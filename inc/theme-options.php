...
function goody_print_dynamic_css() {
    ...
    $dynamic_css = [
        ...
        'h1,h2,h3,h4,h5,h6{font-family:var(--font-heading);}.hero__headline-line--accent,.accent-italic{font-family:var(--font-accent);color:var(--color-primary);}.eyebrow,.site-title,a:hover{color:var(--color-primary);} .hero__content a:hover{color:color-mix(in srgb,var(--color-primary) 72%,var(--color-text) 28%);}',
        ...
        '.goody-reservation-shell .button,.goody-item-select{background:linear-gradient(180deg,color-mix(in srgb,var(--goody-reservation-button) 86%,white 14%),var(--goody-reservation-button));color:var(--goody-reservation-button-text);}.goody-reservation-shell .button:hover,.goody-reservation-shell .button:focus-visible,.goody-item-select:hover,.goody-item-select:focus-visible{background:var(--color-primary-hover);border-color:var(--color-primary-hover);color:var(--goody-reservation-button-text);}',
